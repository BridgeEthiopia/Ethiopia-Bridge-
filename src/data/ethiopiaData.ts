...
import timkatImg from '../assets/images/timkat_gondar_bath_1787814597486.jpg';
...
export const DESTINATIONS_DATA: Destination[] = [
  {
    ...
    gallery: [
      addisImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Addis_Ababa_Meskel_Square.jpg/1280px-Addis_Ababa_Meskel_Square.jpg'
    ],
  ...
  },
  {
    ...
    gallery: [
      baleImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Ethiopian_Wolf_in_Sanetti_Plateau.jpg/1280px-Ethiopian_Wolf_in_Sanetti_Plateau.jpg'
    ],
  ...
  },
  {
    ...
    gallery: [
      lalibelaImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Bet_Giyorgis_church_Lalibela_01.jpg/1280px-Bet_Giyorgis_church_Lalibela_01.jpg'
    ],
  ...
  },
  {
    ...
    gallery: [
      simienImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Simien_Mountains_Landscape.jpg/1280px-Simien_Mountains_Landscape.jpg'
    ],
  ...
  },
  {
    ...
    gallery: [
      gondarImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Fasilides_Castle_Gondar.jpg/1280px-Fasilides_Castle_Gondar.jpg'
    ],
    tagline: '17th Century Imperial Castles & The Angelic Ceiling of Debre Berhan Selassie',
    description: 'The ancient capital of Emperor Fasilides, Gondar is world-renowned for its fortified Fasil Ghebbi royal castle complex, stone bath houses, and the iconic Debre Berhan Selassie Church with its 104 winged angel faces watching over pilgrims.',
    whyVisit: [
    ...
    thingsToDo: [
      ...
      'Attend the thrilling Gondar Timkat celebrations where thousands plunge into blessed waters',
      'Visit Kuskuam Palace and Empress Mentewab’s monastery'
    ],
    keyAttractions: ['Fasil Ghebbi Royal Enclosure', 'Debre Berhan Selassie Church', 'Fasilides’ Bath', 'Kuskuam Palace Complex', 'Gondar Azmari Bet Music Taverns'],
    cultureAndHeritage: 'Gondar was Ethiopia’s capital from 1636 to 1855, famous for ecclesiastical scholarship, classical Gondarine painting, and the Azmari acoustic music tradition.',
    localFoodHighlights: ['Gondar Special Sizzling Tibs', 'Traditional Tej with Masinko performance', 'Authentic Shiro Tegamino'],
    ...
    elevation: '2,133 m',
    nearbyLodging: ['Panoramic Hillside Castle-View Lodges', 'Gondar Heritage Guesthouses', 'Boutique Imperial Stays'],
  ...
  },
  {
    ...
    name: 'Konso Cultural Landscape (UNESCO)',
    ...
    description: 'A UNESCO Cultural World Heritage site spanning arid hillsides painstakingly sculpted with dry-stone agricultural terraces for over 400 years. The Konso people are renowned for their fortified hill-top stone settlements (Kanta), sacred generation trees (Olayta), anthropomorphic wooden funerary statues (Waka), and community council houses (Mora).',
    whyVisit: [
      ...
      'Explore the natural "New York" eroded sandstone canyon formations of Gesergiyo'
    ],
    thingsToDo: [
      'Guided walking tour with a Konso community elder through the walled village of Dokatu or Mecheke',
      'Visit the Konso Cultural Museum displaying authentic historical Waka sculptures',
    ...
    keyAttractions: ['UNESCO Terraced Stone Walls', 'Dokatu Traditional Fortified Village', 'Konso Cultural Museum & Waka Heritage', 'Mora Council Houses', 'Gesergiyo Sandstone Canyons'],
    cultureAndHeritage: 'The Konso have maintained an unbroken egalitarian social system with generation age-grades, sacred clan kings (Poqalla), and master engineering that prevents mountain soil erosion.',
    localFoodHighlights: ['Konso Kurkufa (Steamed Sorghum Balls with Wild Moringa Leaves)', 'Parsa (Refreshing low-alcohol Sorghum brew)', 'Roasted Highland Barley and Legumes'],
    bestTimeToVisit: 'Year-round; best from September to March.',
    scheduleType: 'Customizable Private Itinerary',
    travelTips: ['Respect local village customs and hire an official Konso community guide', 'Visit the local market on Monday or Thursday for an unforgettable cultural sight'],
    elevation: '1,400 to 1,750 m',
    nearbyLodging: ['Konso Hillside Eco-Lodges', 'Community Stone Guesthouses', 'Arba Minch Gateway Lodges'],
  ...
  },
  {
    ...
    gallery: [
      hararImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Harar_Jugol_city_walls.jpg/1280px-Harar_Jugol_city_walls.jpg'
    ],
  ...
  },
  {
    ...
    gallery: [
      danakilImg,
      'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Dallol_Ethiopia.jpg/1280px-Dallol_Ethiopia.jpg'
    ],
...
export const TOURS_DATA: Tour[] = [
  {
    ...
    difficulty: 'Easy',
    priceFromUSD: 85,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Addis_Ababa_Meskel_Square.jpg/1280px-Addis_Ababa_Meskel_Square.jpg',
  ...
  },
  {
    ...
    difficulty: 'Easy',
    priceFromUSD: 0,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Doro_wat.jpg/1280px-Doro_wat.jpg',
  ...
  },
  {
    ...
    difficulty: 'Easy',
    priceFromUSD: 35,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Ethiopian_coffee_ceremony.jpg/1280px-Ethiopian_coffee_ceremony.jpg',
    shortDescription: 'Discover the soul of Ethiopian hospitality with the authentic 3-stage coffee ceremony (Abol, Tona, Baraka). Wash green beans, roast over charcoal with frankincense aroma, grind in wooden mortar, and sip from clay Jebena.',
    itinerarySummary: [
      'Green bean origin story: Tasting beans from Yirgacheffe, Sidama, Harar, and Kafa',
      'Washing and sorting green beans by hand',
      'Charcoal pan roasting with guests passing the fragrant aromatic smoke',
      'Traditional pounding in the wooden Mukecha mortar and Zenezena pestle',
      'Brewing in the black clay Jebena pot on charcoal embers',
      'Tasting the three sacred rounds: Abol (first brew), Tona (second), and Baraka (blessing)',
      'Accompanied by freshly popped corn (fendisha) and roasted barley with peanuts (kolo)'
    ],
    inclusions: ['Complete 3 rounds of single-origin coffee', 'Popcorn, roasted kolo, and local sweets', 'Incense, ceremonial grass matting setup', 'Storytelling on Ethiopian coffee history & cultural etiquette'],
    exclusions: ['Take-home roasted coffee bags (available for purchase)'],
    highlights: ['Abol, Tona, and Baraka ritual rounds', 'Frankincense aromatic smoke blessing', 'Freshly popped corn pairing', 'Clay Jebena brewing craft'],
    rating: 4.98,
    reviewsCount: 215,
    featured: true,
  },
  ...
  },
  {
    ...
    difficulty: 'Moderate',
    priceFromUSD: 620,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Ethiopian_Wolf_in_Sanetti_Plateau.jpg/1280px-Ethiopian_Wolf_in_Sanetti_Plateau.jpg',
  ...
  },
  {
    ...
    difficulty: 'Moderate',
    priceFromUSD: 420,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Bet_Giyorgis_church_Lalibela_01.jpg/1280px-Bet_Giyorgis_church_Lalibela_01.jpg',
  ...
  },
  {
    ...
    difficulty: 'Moderate',
    priceFromUSD: 890,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Hamer_tribe_Ethiopia.jpg/1280px-Hamer_tribe_Ethiopia.jpg',
  ...
  },
  {
    ...
    difficulty: 'Easy',
    priceFromUSD: 380,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Harar_Jugol_city_walls.jpg/1280px-Harar_Jugol_city_walls.jpg',
  ...
  },
  {
    ...
    priceFromUSD: 590,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Dallol_Ethiopia.jpg/1280px-Dallol_Ethiopia.jpg',
...
export const FOOD_DISHES_DATA: FoodDish[] = [
  ...
  },
  {
    ...
    nativeName: 'ክትፎ',
    category: 'meat',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Kitfo_with_ayib_and_gomen.jpg/1280px-Kitfo_with_ayib_and_gomen.jpg',
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Shiro_in_clay_pot.jpg/1280px-Shiro_in_clay_pot.jpg',
  ...
  },
  {
    ...
    category: 'fasting-vegan',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Ethiopian_fasting_food_Beyaynetu.jpg/1280px-Ethiopian_fasting_food_Beyaynetu.jpg',
  ...
  },
  {
    ...
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Injera_with_wot.jpg/1280px-Injera_with_wot.jpg',
...
export const BUSINESSES_DATA: BusinessListing[] = [
  ...
  },
  {
    ...
    image: '', // Real photo upload placeholder
    packageType: 'Premium Listing',
    status: 'active',
    isVerified: true,
...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Bet_Giyorgis_church_Lalibela_01.jpg/1280px-Bet_Giyorgis_church_Lalibela_01.jpg',
  ...
  },
  {
    ...
    category: 'Nature',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Simien_Mountains_Landscape.jpg/1280px-Simien_Mountains_Landscape.jpg',
  ...
  },
  {
    ...
    category: 'Coffee',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Ethiopian_coffee_ceremony.jpg/1280px-Ethiopian_coffee_ceremony.jpg',
  ...
  },
  {
    ...
    category: 'Food',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Doro_wat.jpg/1280px-Doro_wat.jpg',
    location: 'Hindek Kitchen, Addis Ababa',
    caption: 'Slow-cooked celebration Doro Wat with hard-boiled eggs and 100% Teff Injera.'
  },
  {
    id: 'gal-5',
    title: 'Fasil Ghebbi Imperial Castle Complex',
    category: 'Historical Sites',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Fasilides_Castle_Gondar.jpg/1280px-Fasilides_Castle_Gondar.jpg',
    location: 'Gondar',
    caption: 'The 17th-century stone palaces of Emperor Fasilides.'
  },
  {
    id: 'gal-6',
    title: 'Timkat Celebration at Fasilides Bath',
    category: 'Festivals',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Timkat_Festival_Gondar.jpg/1280px-Timkat_Festival_Gondar.jpg',
    location: 'Gondar',
    caption: 'The dawn blessing of water during Epiphany at Emperor Fasilides’ Bath.'
  },
  {
    id: 'gal-7',
    title: 'Endangered Ethiopian Wolf on Sanetti Plateau',
    category: 'Wildlife',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Ethiopian_Wolf_in_Sanetti_Plateau.jpg/1280px-Ethiopian_Wolf_in_Sanetti_Plateau.jpg',
  ...
  },
  {
    ...
    category: 'Nature',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Dallol_Ethiopia.jpg/1280px-Dallol_Ethiopia.jpg',
