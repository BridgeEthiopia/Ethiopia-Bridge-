  ...
  const kitchenCookingDishes = [
    {
      ...
      current: getCustomPhoto('kitchen-dish-teff-injera', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Injera_with_six_different_kinds_of_stew.jpg/1280px-Injera_with_six_different_kinds_of_stew.jpg'),
      defaultSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Injera_with_six_different_kinds_of_stew.jpg/1280px-Injera_with_six_different_kinds_of_stew.jpg',
    },
    {
      ...
      current: getCustomPhoto('kitchen-dish-doro-wat', 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Doro_wat.jpg/1280px-Doro_wat.jpg'),
      defaultSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Doro_wat.jpg/1280px-Doro_wat.jpg',
    },
    {
      ...
      current: getCustomPhoto('kitchen-dish-sizzling-tibs', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Ethiopian_Tibs.jpg/1280px-Ethiopian_Tibs.jpg'),
      defaultSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Ethiopian_Tibs.jpg/1280px-Ethiopian_Tibs.jpg',
    },
    {
      ...
      current: getCustomPhoto('kitchen-dish-kitfo', 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Kitfo_Ethiopian_dish.jpg/1280px-Kitfo_Ethiopian_dish.jpg'),
      defaultSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Kitfo_Ethiopian_dish.jpg/1280px-Kitfo_Ethiopian_dish.jpg',
    },
    {
      ...
      current: getCustomPhoto('kitchen-dish-shiro-tegamino', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Shiro_in_clay_pot.jpg/1280px-Shiro_in_clay_pot.jpg'),
      defaultSrc: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Shiro_in_clay_pot.jpg/1280px-Shiro_in_clay_pot.jpg',
    }
  ];
