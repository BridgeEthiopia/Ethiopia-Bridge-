    ...
    <section className="relative pt-24 lg:pt-32 pb-16 lg:pb-24 overflow-hidden" id="hero-section">
      ...
      <div className="absolute inset-0 -z-10 bg-[#FAF8F5]">
        <div 
          ...
          style={{
            backgroundImage: `url('https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Bet_Giyorgis_Lalibela_Ethiopia.jpg/1280px-Bet_Giyorgis_Lalibela_Ethiopia.jpg')`
          }}
        />
