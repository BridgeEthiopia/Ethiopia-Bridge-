            ...
            <button
              ...
              className={`text-[11px] px-2 py-0.5 rounded border transition-colors cursor-pointer ${
                isAdminMode 
                  ...
                  : 'text-[#8C7E6D] hover:text-[#1E3A2F] border-[#D9D0C1]'
              }`}
              title={isAdminMode ? 'Founder Mode is Active (Click to open manager)' : 'Founder Sign-in / Photo Manager'}
            >
              {isAdminMode ? '👑 Founder Mode' : 'Admin'}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <nav className="hidden xl:flex items-center gap-1 2xl:gap-2 text-sm font-medium text-[#423B33]">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-1 w-64 bg-white rounded-xl shadow-xl border border-[#E8E1D5] py-2 hidden group-hover:block transition-all animate-in fade-in duration-200">
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-sm">{t('nav_coffee', 'Grandpa Coffee')}</div>
                  <div className="text-[11px] text-[#7A7063]">3-Cup Sacred Ceremony</div>
                </div>
              </button>
              <button
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full right-0 mt-1 w-56 bg-white rounded-xl shadow-xl border border-[#E8E1D5] py-2 hidden group-hover:block transition-all animate-in fade-in duration-200">
              <button
        ...
        <div className="hidden lg:flex items-center gap-2.5">
          ...
          <button
            ...
            title="Upload your own real photos"
          >
            <Camera className="w-3.5 h-3.5 text-[#B85C38]" />
